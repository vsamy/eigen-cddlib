...
#ifndef EIGEN_CDDLIB_DEPRECATED_HH
# define EIGEN_CDDLIB_DEPRECATED_HH
...
//  void foo () EIGEN_CDDLIB_DEPRECATED;
//
// Tagging a type as deprecated:
//  class Foo {};
//  typedef Foo Bar EIGEN_CDDLIB_DEPRECATED;
//
// Tagging a variable as deprecated:
//  int a EIGEN_CDDLIB_DEPRECATED = 0;
//
...
# ifdef __GNUC__
#  define EIGEN_CDDLIB_DEPRECATED __attribute__ ((deprecated))
# else
#  if defined(_MSC_VER) && !defined(__INTEL_COMPILER)
#   define EIGEN_CDDLIB_DEPRECATED __declspec (deprecated)
#  else
// If the compiler is not recognized, drop the feature.
#   define EIGEN_CDDLIB_DEPRECATED /* nothing */
#  endif // __MSVC__
# endif // __GNUC__

#endif //! EIGEN_CDDLIB_DEPRECATED_HH
